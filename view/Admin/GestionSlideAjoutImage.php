...
<h1 class="lamarge txt-center"> Ajout d'une photo de slide </h1>

<form class="col-12 lamarge" method='POST' action='gestionslideajoutimage'>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO photoslide VALUES (? , ?)"; 
