...
?>
<h1 class="txt-center lamarge"> Ajout d'une photo d'un produit </h1>
<form class="col-12 lamarge" method='POST' action='gestionproduitajoutimage'>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO illustration VALUES (? , ?)"; 
