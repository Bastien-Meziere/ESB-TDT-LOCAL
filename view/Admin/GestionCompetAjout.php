...
?>
<h1 class="lamarge txt-center"> Ajout d'une section de la page Compétitions </h1>

<form class="col-12 lamarge" method='POST' action='gestioncompetajout'>
        <table  width="95%" border="1" cellspacing="0" cellpadding="4">
            ...
            <thead> <tr>  <th> <b> Numéro </th>  <td> <input type='text' size='40' name='Ref' required> </td> </tr>       
             	<tr>  <th> <b> Description </th>  <td> <input type='text' size='120' name='Desc' required> </td> </tr>
					<tr>  <th> <b> Numéro Document </th>  <td> <input type='text' size='40' name='RefPhoto' required> </td> </tr>
