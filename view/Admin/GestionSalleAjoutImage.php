...
?>
<h1 class="lamarge txt-center"> Ajout d'une photo de la page Salle </h1>

<form class="col-12 lamarge" method='POST' action='gestionsalleajoutimage'>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO photosalle VALUES (? , ?)"; 
