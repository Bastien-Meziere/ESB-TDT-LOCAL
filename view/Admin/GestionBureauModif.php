...
if (!isset($_POST['Ref']))
{
  ...
  // Affichage de la news dans un formulaire 
	...
	//var_dump($UnBureau);
	?>
<h1 class="lamarge txt-center"> Modification d'un membre du bureau </h1>
...
<form method='POST' action='gestionbureaumodif' class="col-12 lamarge">
    <table  width="95%" border="1" cellspacing="0" cellpadding="4">
        <thead> 
        	...
        	<tr>  <th> <b> Photo </th>  <td> <input type='text' size='5' name='Photo' value='<?php echo $UnBureau->id_photobureau;?>'> </td> </tr>      
        </thead>
    </table>
