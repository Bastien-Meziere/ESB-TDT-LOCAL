...
<form method='POST' action='gestionprochainmatchmodif' class="col-12 lamarge">
    <table  width="95%" border="1" cellspacing="0" cellpadding="4">
        <thead> 
        	...
        	<tr>  <th> <b> Phrase 1 </th>  <td> <input type='text' size='80' name='Cont' value='<?php echo $UnProchainMatch->content_match;?>'> </td> </tr>
        	<tr>  <th> <b> Phrase 2 </th>  <td> <input type='text' size='80' name='Cont2' value='<?php echo $UnProchainMatch->content2_match;?>'> </td> </tr>    
	...
	<br/>
	   ...
	   <a href='<?=WEBROOT.'admin/gestionprochainmatch'?>'><img border=0 src='../asset/images/Annuler.png'></a>
	</div> 
</form>
<?php
}
