...
?>
<h1 class="lamarge txt-center"> Ajout d'un entraîneur </h1>

<form class="col-12 lamarge" method='POST' action='gestionentrainementajout'>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO entrainement VALUES (? , ? , ? , ? , ?)"; 
