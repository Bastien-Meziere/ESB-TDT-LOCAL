...
<h1 class="txt-center lamarge"> Modification des derniers résultats </h1>
...
<form method='POST' action='gestionresultatmatchmodif' class="col-12 lamarge">
		...
		<div class="row lamarge table-responsive">
			<table class="table table-striped table-hover" width="95%" cellspacing="0" cellpadding="4">
				<thead> 
					...
					<tr>  <th> <b> Équipe 1 </th>  <td> <input type='text' size='80' name='Cont' value='<?php echo $UnResultatMatch->content_resultat;?>'> </td> </tr>
					<tr>  <th> <b> Équipe 2 </th>  <td> <input type='text' size='80' name='Cont2' value='<?php echo $UnResultatMatch->content2_resultat;?>'> </td> </tr>    
	...
	<input type='hidden' name='Ref' value='<?php echo $UnResultatMatch->num_resultat;?>'>
		...
		<a href='<?=WEBROOT.'admin/gestionresultatmatch'?>'><img src='../asset/images/Annuler.png'></a>
		</div>
		</div>
	</div>
</form>
