...
?>
<h1 class="lamarge txt-center"> Ajout d'un document de la page Compétitions </h1>

<form class="col-12 lamarge" method='POST' action='gestioncompetajoutimage'>
	<div class="container-fluid">
    	<div class="row lamarge table-responsive">
			<table class="table table-striped table-hover" width="95%" cellspacing="0" cellpadding="4">
				...
				<thead> <tr>  <th> <b> Numéro Document</th>  <td> <input type='text' size='40' name='Ref' required> </td> </tr>       
						<tr>  <th> <b> Nom Document </th>  <td> <input type='text' size='40' name='RefPhoto' required> </td> </tr>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO photocompet VALUES (? , ?)"; 
