...
?>
<h1 class="lamarge txt-center"> Ajout d'une photo d'équipe (Page Accueil) </h1>

<form class="col-12 lamarge" method='POST' action='gestionequipeajoutimage'>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $sql="INSERT INTO photoequipe VALUES (? , ?)"; 
