...
<h1 class="txt-center lamarge"> Ajout d'un produit </h1>

<form class="col-12 lamarge titreadmin" method='POST' action='gestionproduitajout'>
		...
		<div class="row lamarge table-responsive">
			<table class="table table-striped table-hover" width="95%" cellspacing="0" cellpadding="4">
				...
				<tr>  <th> <b> Désignation </th>  <td> <input type='text' size='40' name='Desig' required> </td> </tr>
					<tr>  <th> <b> Description </th>  <td> <input type='text' size='80' name='Desc' required> </td> </tr>
...
// Mise à jour du contenu de la page dans la base de données 
		   ...
		   $resultats=$connexion->prepare($sql); 
	  	   $resultats->execute(array( $_POST['Ref'] , $_POST['Desig'], $_POST['Desc'], $_POST['Prix'], $_POST['RefPhoto'] ));
